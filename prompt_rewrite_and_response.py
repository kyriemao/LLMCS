...
from promptor import RewriteAndResponsePromptor
...
def main():
    ...
    promptor = RewriteAndResponsePromptor()
    ...
    with open(output_file_path, "a+") as f:
        for i in trange(len(test_dialogs)):
            ...
            for j in trange(len(turns)):
                ...
                # output info
                print("{}, sample_id: {} \n predicted rewrite: {} \n predicted response: {}".format(args.work_dir, sample_id, rewrite_list[0], response_list[0]))
